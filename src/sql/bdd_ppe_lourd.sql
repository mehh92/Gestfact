...
(
    ...
    etat_du_contrat enum ('valide','resilier', 'en cours') not null,
...
then
    ...
    set message_text = 'il s agit d une prestation materielle';
end if;
...
(null,1,'2010-05-10','Valide','depannage informatique',113.50),
(null,2,'1998-07-15','Resilier','maintenance informatique', 200.10),
(null,3,'2001-12-21','Resilier','assistance 24/24', 107.35);
...
(null,1 ,'Prestation M1', 70.30, 47.20, 'Carte electronique'),
...
(null, 1, '2020-06-12', 130.00, 'payer');
